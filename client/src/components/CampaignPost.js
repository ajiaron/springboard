            ...
            <div className='campaign-post-content-container'>
                ...
                <div className='campaign-post-top-content'>
                    <div className='campaign-post-header'>
                        ...
                        <span style={{display:"flex"}}>
                            ...
                            style={{ paddingLeft:".8em", fontFamily:"Inter",color:"#6e6e6e",transform:"translateY(-0.02em)"}}>
                                {`•`}
                            </p>
                            <p className='campaign-post-header-subtext' 
                            style={{  alignSelf:"center",
                                fontSize: "clamp(10px, 3vw, 14.5px)",paddingLeft:".8em", fontFamily:"Rubik", color:"#707070",transform:"translateY(-0.0175em)"}}>
                                {`5 days ago`}
                            </p>
                        </span>
                ...
                <div className='campaign-post-footer' >
                    ...
                    <div className='campaign-post-footer-item-wrapper'>
                        ...
                        <p className='campaign-post-caption-subtext' style={{fontWeight:"600", paddingTop:".0145em"}}>
                            64
                        </p>
                    </div>
                    <div className='campaign-post-footer-item-wrapper'>
